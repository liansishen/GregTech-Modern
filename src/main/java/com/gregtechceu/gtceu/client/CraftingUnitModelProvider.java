...
import com.gregtechceu.gtceu.common.data.AddItemsAndBlocks;
...
@OnlyIn(Dist.CLIENT)
public class CraftingUnitModelProvider extends AbstractCraftingUnitModelProvider<AddItemsAndBlocks.CraftingUnitType> {
    ...
    public CraftingUnitModelProvider(AddItemsAndBlocks.CraftingUnitType type) {
        super(type);
    }
    ...
    private static Material texture(String name) {
        var material = new Material(InventoryMenu.BLOCK_ATLAS, GTCEu.id("block/crafting/" + name));
    ...
    public static void initCraftingUnitModels() {
        for (AddItemsAndBlocks.CraftingUnitType type : AddItemsAndBlocks.CraftingUnitType.values()) {
            BuiltInModelHooks.addBuiltInModel(
                    GTCEu.id("block/crafting/" + type.getAffix() + "_formed"),
    ...
    private static void setRenderLayer(FMLClientSetupEvent event) {
        ItemBlockRenderTypes.setRenderLayer(AddItemsAndBlocks.CRAFTING_STORAGE_1M.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(AddItemsAndBlocks.CRAFTING_STORAGE_4M.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(AddItemsAndBlocks.CRAFTING_STORAGE_16M.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(AddItemsAndBlocks.CRAFTING_STORAGE_64M.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(AddItemsAndBlocks.CRAFTING_STORAGE_256M.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(AddItemsAndBlocks.CRAFTING_STORAGE_256G.get(), RenderType.cutout());
    }
}
