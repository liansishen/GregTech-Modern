...
public class ContentBuilder {
    ...
    public ContentBuilder itemsIS(ItemStack... inputs) {
        ...
        return addContent(ItemRecipeCapability.CAP,
    ...
    public ContentBuilder fluid(FluidStack input) {
        return addContent(FluidRecipeCapability.CAP, FluidIngredient.of(
    ...
    public ContentBuilder fluids(FluidStack... inputs) {
        return addContent(FluidRecipeCapability.CAP,
                Arrays.stream(inputs).map(fluid -> {
                    if (!Platform.isForge() && fluid.getFluid() == Fluids.WATER) {
