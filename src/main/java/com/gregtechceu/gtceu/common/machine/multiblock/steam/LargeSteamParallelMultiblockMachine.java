...
public class LargeSteamParallelMultiblockMachine extends WorkableMultiblockMachine implements IDisplayUIMachine {
    ...
    private static int max_parallels;
    ...
    public LargeSteamParallelMultiblockMachine(IMachineBlockEntity holder, int max_parallels, Object... args) {
        super(holder, args);
        LargeSteamParallelMultiblockMachine.max_parallels = max_parallels;
    }
    ...
    public static GTRecipe recipeModifier(MetaMachine machine, @NotNull GTRecipe recipe) {
        ...
        recipe.duration = (int) (duration * 0.75);
